...
#bgr = [Image.open(args.video_bgr).convert('RGB')]   #images
...
bgr = VideoDataset(args.video_bgr)

# VideoDataset(args.video_src)
 
# # Check if camera opened successfully
# if (bgr.isOpened()== False): 
...
if args.output_format == 'video':
    ...
    if 'com' in args.output_types:
        com_writer = VideoWriter(os.path.join(args.output_dir, 'comopop.mp4'), vid.frame_rate, w, h)
